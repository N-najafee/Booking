...
// window.PersianDatepicker = require('persian-datepicker');
...
(function ($) {
    ...
    $('.slider-active').owlCarousel({
        ...
        nav: true,
        autoplay: false,
        navText: ['<i class="szli sli-arrow-left"></i>', '<i class="sli sli-arrow-right"></i>'],
    ...
    ------------------------------------*/
    var checked = $('.sin-paymentCreate input:checked')
    if (checked) {
        $(checked).siblings('.paymentCreate-box').slideDown(900);
    };
    $('.sin-paymentCreate input').on('change', function () {
        $('.paymentCreate-box').slideUp(900);
        $(this).siblings('.paymentCreate-box').slideToggle(900);
    });
